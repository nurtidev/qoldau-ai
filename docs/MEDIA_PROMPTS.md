...
> and a row of distant wind turbines catch the low sun. A small dusty pickup truck with a faded
...
> drift toward the train. Motion sources: the distant wind turbine blades turn slowly, dust and
> heat haze drift along the rail yard, clouds creep almost imperceptibly across the sky, a loose
...
> Kazakhstan streetscape — modest but active. No text, no logos, no readable signage, 16:9, high
> resolution.
...
> across the gravel. No people, no text, no logos, no visible brand emblems, 16:9, high resolution.
...
> business optimism. No readable text, no logos, no faces, 16:9, high resolution.
...
**Стилл (EN):**
> Photorealistic golden-hour shot of a container terminal at the Port of Aktau on the Caspian Sea:
> tall gantry cranes silhouetted against a warm sunset sky, neat stacks of shipping containers in
> muted industrial colors with one stack corner catching a warm golden highlight, a cargo ship
> docked at the quay in the background, calm sea reflecting the sky. Faint haze over the water.
> No people, no text, no logos, no readable container markings, 16:9, high resolution.
...
> furrows, a few scattered clouds. No people in sharp focus, no text, no logos, 16:9, high
> resolution.
