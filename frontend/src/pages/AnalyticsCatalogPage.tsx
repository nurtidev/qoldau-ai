...
const MATERIALS: Material[] = [
  ...
  { id: 2,  title: 'Финансовая отчётность АО «Демеу» за 2025',              org: 'Демеу',              type: 'Финансовая отчётность',   period: '2025',       source: 'demeu.kz',                     updated: '28.02.2026', format: 'pdf',   url: '#' },
  ...
  { id: 4,  title: 'Исследование экспортного потенциала АПК',              org: 'KazExport',          type: 'Исследование',           period: '2025',       source: 'kazexport.kz',                 updated: '18.01.2026', format: 'pdf',   url: '#' },
  { id: 5,  title: 'Годовой отчёт KazGuarantee за 2025',                    org: 'KazGuarantee',       type: 'Годовой отчёт',           period: '2025',       source: 'kazguarantee.kz',              updated: '20.02.2026', format: 'pdf',   url: '#' },
  { id: 6,  title: 'Дашборд портфеля гарантийных продуктов',                org: 'KazGuarantee',       type: 'Дашборд',                 period: 'Q1 2026',    source: 'kazguarantee.kz',              updated: '02.04.2026', format: 'embed', url: '#' },
  { id: 7,  title: 'Финансовая отчётность «АгроКапитал» за 2025',           org: 'АгроКапитал',        type: 'Финансовая отчётность',   period: '2025',       source: 'agrokapital.kz',               updated: '15.03.2026', format: 'pdf',   url: '#' },
  { id: 8,  title: 'Интерактивный отчёт по венчурным инвестициям',          org: 'ИнноФонд',           type: 'Интерактивный отчёт',     period: 'Q1 2026',    source: 'innofond.kz',                  updated: '10.04.2026', format: 'web',   url: '#' },
  { id: 9,  title: 'Исследование рынка коммерческой недвижимости',         org: 'Astana Capital',    type: 'Исследование',           period: '2025',       source: 'astanacapital.kz',             updated: '22.01.2026', format: 'pdf',   url: '#' },
  { id: 10, title: 'Дашборд по проектам льготного лизинга',                 org: 'Демеу',              type: 'Дашборд',                 period: 'Q1 2026',    source: 'demeu.kz',                     updated: '30.03.2026', format: 'embed', url: '#' },
  ...
  { id: 13, title: 'Исследование цифровизации дочерних организаций',       org: 'ИнноФонд',           type: 'Исследование',           period: '2025',       source: 'innofond.kz',                  updated: '14.02.2026', format: 'pdf',   url: '#' },
  { id: 14, title: 'Дашборд экспортных сделок KazExport',                   org: 'KazExport',          type: 'Дашборд',                 period: 'Q1 2026',    source: 'kazexport.kz',                 updated: '01.04.2026', format: 'embed', url: '#' },
]
